    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="card-header">
                <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-quote-right"></i> About Siswa</h6>
            </div>
                <div class="card-body text-center">
                        <img src="{{ asset('/template/img/'.$siswa->foto) }}" width="200" height="200" class="rounded-circle mt-3 mx-auto img-thumbail"><br>
                    <h4 class="mt-3">{{ $siswa->nama }}</h4>
                    <h5 class="mt-3"><i class="fas fa-id-card"> {{ $siswa->nisn }}</i></h5>
                    <h5 class="mt-3"><i class="fas fa-venus-mars"> {{ $siswa->jk }}</i></h5>
                    <h5 class="mt-3"><i class="fas fa-map"> {{ $siswa->alamat }}</i></h5>
                </div>
          </div>
            <div class="card shadow mb-4">
                <div class="card-header">
